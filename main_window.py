...
class MyWindow(wx.Frame):
    ...
    def __init__(self, parent, title):
        ...
        menuAbout = filemenu.Append(wx.ID_ABOUT, "&About"," Click for info about the application")
    ...
    def OnAbout(self,e):
        ...
        dlg = wx.MessageDialog( self, "An applet that simulates the 3 Body Probelm", "Jarred Green 2016", wx.OK)
